...
SRC_URI="amd64? (
https://download2.ebz.epson.net/iscan/plugin/perfection-v550/rpm/x86/iscan-perfection-v550-bundle-"${EPS_VER}".x64.rpm.tar.gz )
x86? (
https://download2.ebz.epson.net/iscan/plugin/perfection-v550/rpm/x64/iscan-perfection-v550-bundle-"${EPS_VER}".x86.rpm.tar.gz )"
LICENSE="AVASYS"
SLOT="0"
KEYWORDS="-* ~amd64 ~x86"
